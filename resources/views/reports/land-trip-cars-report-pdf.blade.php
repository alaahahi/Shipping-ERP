...
<head>
    ...
    <style>
        ...
        td.vin { font-family: DejaVu Sans Mono, DejaVu Sans, sans-serif; font-size: 8px; }
...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="14">No cars match the selected filter.</td>
                </tr>
            @endforelse
        </tbody>
        @if (count($rows) > 0)
